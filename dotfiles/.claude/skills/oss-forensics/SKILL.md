...
name: oss-forensics
description: |
  Use when investigating a GitHub repo for supply-chain compromise, recovering deleted or
  force-pushed commits, detecting force-pushes, extracting IOCs, collecting multi-source
  evidence (GitHub API, GH Archive/BigQuery, Wayback Machine, local git), forming and
  validating evidence-backed hypotheses, or producing a structured forensic report.
...
**Commands**: Run the clone, full-history log, `git fsck`, reflog, branch-listing, binary-addition, and GPG-signature blocks in [investigator-commands.md § Investigator 1](./references/investigator-commands.md#investigator-1-local-git-investigator).
...
**Commands**: Run the commits/PRs/issues/contributors/events/commit-detail/releases endpoint set in [investigator-commands.md § Investigator 2](./references/investigator-commands.md#investigator-2-github-api-investigator).
...
**Commands**: Run the CDX search and snapshot-fetch set in [investigator-commands.md § Investigator 3](./references/investigator-commands.md#investigator-3-wayback-machine-investigator).
...
**Commands**: Run the cost-optimization rules (MANDATORY: dry-run first, `_TABLE_SUFFIX` date filtering, select only needed columns, LIMIT unless aggregating) and the PushEvent/DeleteEvent BigQuery templates in [investigator-commands.md § Investigator 4](./references/investigator-commands.md#investigator-4-gh-archive--bigquery-investigator). Full query patterns for all 12 event types are in [github-archive-guide.md](./references/github-archive-guide.md).
...
- [investigator-commands.md](./references/investigator-commands.md) -- verbatim Phase 2 per-investigator collection command blocks
