...
**CRITICAL:** Always use `write_note` (Basic Memory MCP) - NEVER use file write
tools or write design documents to local filesystem folders.
...
1. Save spec to Basic Memory with `write_note` (Basic Memory MCP)
2. Declare:
   "**Phase Complete:
   EXPLORE -> PLAN**"
3. Suggest:
