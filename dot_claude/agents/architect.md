...
Before writing the spec, search for:
...
- Use **Serena MCP** (`mcp__serena__find_symbol`,
  `mcp__serena__find_referencing_symbols`) for code symbol lookups
- Search code with **Grep**, **Glob**, and **Read** for text patterns and file
  exploration before proposing solutions
