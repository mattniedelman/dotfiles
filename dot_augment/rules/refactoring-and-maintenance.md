...
- **Rule**:
  Approach refactoring systematically with clear goals and measurable outcomes
- **Rationale**:
  Based on observed pattern of comprehensive refactoring in pytest plugin
- **Implementation**:
...
- **Rule**:
  Prefer consolidating related functionality over creating multiple small
  modules
- **Rationale**:
...
- **Rule**:
  Always look for opportunities to remove code before adding new functionality
- **Implementation**:
...
- **Rule**:
  Actively identify and document technical debt with clear remediation plans
- **Implementation**:
...
- **Rule**:
  Make incremental improvements to code quality with each change
- **Implementation**:
...
- **Rule**:
  Handle legacy code with care while planning for modernization
- **Implementation**:
...
- **Rule**:
  Actively work to reduce code complexity and cognitive load
- **Implementation**:
...
- **Rule**:
  Continuously simplify and improve API design
- **Implementation**:
...
- **Rule**:
  Improve error handling and debugging capabilities during refactoring
- **Implementation**:
...
- **Rule**:
  Use tests to guide and validate refactoring efforts
- **Implementation**:
...
- **Rule**:
  Implement comprehensive regression testing for refactored code
- **Implementation**:
...
- **Rule**:
  Document the rationale and impact of significant refactoring efforts
- **Implementation**:
...
- **Rule**:
  Communicate refactoring changes clearly to team members
- **Implementation**:
...
- **Rule**:
  Use refactoring as an opportunity for knowledge transfer
- **Implementation**:
