...
- **Rule**:
  Design RESTful endpoints that follow consistent patterns and naming
  conventions
- **Implementation**:
...
- **Rule**:
  Design APIs with evolution in mind from the start
- **Implementation**:
...
- **Rule**:
  Create client classes with intuitive, consolidated interfaces
- **Rationale**:
  Based on observed pattern of simplifying client interactions
- **Implementation**:
...
- **Rule**:
  Use well-defined DTOs for data exchange between services
- **Implementation**:
...
- **Rule**:
  Centralize and standardize configuration handling across services
- **Implementation**:
...
- **Rule**:
  Design resilient integrations with external services
- **Implementation**:
...
- **Rule**:
  Implement consistent security patterns across all services
- **Implementation**:
...
- **Rule**:
  Define explicit Pydantic models for all request and response data
- **Implementation**:
...
- **Rule**:
  Implement consistent middleware for cross-cutting concerns
- **Implementation**:
